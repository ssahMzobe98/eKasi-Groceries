...
<div id="infowindow-content">
    ...
    <div style="padding: 10px 10px;width: 100%;">
        ...
        <div class="setAddress" onclick="setAddress()">Set Address</div>

    </div>
<script
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB1x-J3LYyeaD1L-1SmkLg99rShtwXjhFI&callback=initMap&libraries=places&v=weekly"
    defer
></script>