...
if(isset($_SESSION['user_agent'],$_SESSION['var_agent'])){
  ...
  if($cur_user_row['user_type']=='admin'){
  ...
  <head>
    <meta charset="UTF-8">
     ...
     <meta name="description" content="E-Learning for all SGELA is an app engineered to simplify all tertiary & bursary applications and easily accessible.">
      ...
      <link rel="alternate" type="application/rss+xml" title="E-Learning for all &raquo; Feed" href="https://netchatsa.com/feed/" />
      <link rel="alternate" type="application/rss+xml" title="E-Learning for all &raquo; Comments Feed" href="https://netchatsa.com/feed/" />
